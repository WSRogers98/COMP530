...
currcommand=calloc((totalchars+1),sizeof(char));
//used for both in and outfiles
char *currfile;
currfile=NULL;
currfile=calloc((totalchars+1),sizeof(char));
  ...
  for(int i=0; i< strlen(inbuf); i++){
    ...
    if (inbuf[i]=='|' && iscomment !=true){
        ...
        //end infile
          ...
          *infile=malloc(sizeof(char*)*(strlen(currfile)+1));
          strcpy(*infile,currfile);
          isin=false;
          currfile=NULL;
         currfile=calloc((totalchars+1),sizeof(char));
          fileindex=0;
        ...
        //end outfile
          ...
          *outfile=malloc(sizeof(char*)*(strlen(currfile)+1));
          strcpy(*outfile,currfile);
          isout=false;
          currfile=NULL;
          currfile=calloc((totalchars+1),sizeof(char));
          fileindex=0;
